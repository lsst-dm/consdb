...
Revision ID: 14a00ef0cbc3
Revises:
Create Date: 2024-11-12 18:36:02.453009+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["key"], ["cdb_startrackerfast.exposure_flexdata_schema.key"], name="fk_exposure_flexdata_key"
        ),
        sa.ForeignKeyConstraint(
            ["obs_id"], ["cdb_startrackerfast.exposure.exposure_id"], name="fk_exposure_flexdata_obs_id"
        ),
...
def downgrade() -> None:
    op.drop_table("exposure_quicklook", schema="cdb_startrackerfast")
    op.drop_table("exposure_flexdata", schema="cdb_startrackerfast")
    op.drop_table("exposure_flexdata_schema", schema="cdb_startrackerfast")
    op.drop_table("exposure", schema="cdb_startrackerfast")
