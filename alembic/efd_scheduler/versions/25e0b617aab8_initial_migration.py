...
def upgrade() -> None:
    ...
    op.execute("GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA efd2_scheduler TO oods")
    op.execute("GRANT SELECT ON ALL TABLES IN SCHEMA efd2_scheduler TO usdf")
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("lsstcomcam", schema="efd2_scheduler")
    op.drop_table("lsstcam", schema="efd2_scheduler")
    op.drop_table("latiss", schema="efd2_scheduler")
    # ### end Alembic commands ###
