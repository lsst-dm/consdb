...
Revision ID: 983ecbea5f7d
Revises: d54a539aad4d
Create Date: 2024-09-05 23:35:11.648023+00:00
...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "un_ccdexposure_id", "ccdexposure", ["ccdexposure_id"], schema="cdb_lsstcomcam"
    )
    op.create_unique_constraint(
...
def downgrade() -> None:
    ...
    op.drop_constraint("fk_day_obs_seq_num", "ccdexposure", schema="cdb_lsstcomcam", type_="foreignkey")
    op.create_foreign_key(
        "fk_exposure_id",
        "ccdexposure",
        "exposure",
    ...
    op.drop_constraint("un_day_obs_seq_num_detector", "ccdexposure", schema="cdb_lsstcomcam", type_="unique")
    op.drop_constraint("un_ccdexposure_id", "ccdexposure", schema="cdb_lsstcomcam", type_="unique")
    op.create_unique_constraint(
