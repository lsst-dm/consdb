...
Revision ID: e5c1175d6a69
Revises: 8ace2ff4175d
Create Date: 2025-06-09 21:34:44.974540+00:00
...
revision: str = "e5c1175d6a69"
down_revision: str | None = "8ace2ff4175d"
...
def downgrade() -> None:
    op.execute("DROP VIEW IF EXISTS cdb_lsstcomcam.ccdvisit1")
    op.execute("DROP VIEW IF EXISTS cdb_lsstcomcam.visit1")
    op.drop_column("exposure", "can_see_sky", schema="cdb_lsstcomcam")
