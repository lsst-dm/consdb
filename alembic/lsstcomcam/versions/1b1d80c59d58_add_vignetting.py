...
Revision ID: 1b1d80c59d58
Revises: 334168d54b40
Create Date: 2024-06-25 09:42:37.901378+00:00
...
revision: str = "1b1d80c59d58"
down_revision: str | None = "334168d54b40"
...
def downgrade() -> None:
    ...
    op.drop_column("exposure", "vignette_min", schema="cdb_lsstcomcam")
    op.drop_column("exposure", "vignette", schema="cdb_lsstcomcam")
    op.alter_column(
        "ccdvisit1_quicklook",
