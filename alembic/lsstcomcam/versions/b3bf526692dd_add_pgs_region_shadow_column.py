...
Revision ID: b3bf526692dd
Revises: e5c1175d6a69
Create Date: 2025-09-30 19:08:56.610135+00:00
...
revision: str = "b3bf526692dd"
down_revision: str | None = "e5c1175d6a69"
...
def downgrade() -> None:
    op.execute("DROP VIEW IF EXISTS cdb_lsstcomcam.ccdvisit1")
    op.execute("DROP VIEW IF EXISTS cdb_lsstcomcam.visit1")
    op.drop_column("exposure", "pgs_region", schema="cdb_lsstcomcam")
    op.drop_column("ccdexposure", "pgs_region", schema="cdb_lsstcomcam")
