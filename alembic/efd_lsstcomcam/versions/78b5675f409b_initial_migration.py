...
def upgrade() -> None:
    ...
    op.execute("GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA efd_lsstcomcam TO oods")
    op.execute("GRANT SELECT ON ALL TABLES IN SCHEMA efd_lsstcomcam TO usdf")


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("visit1_efd_unpivoted", schema="efd_lsstcomcam")
    op.drop_table("visit1_efd", schema="efd_lsstcomcam")
    op.drop_table("exposure_efd_unpivoted", schema="efd_lsstcomcam")
    op.drop_table("exposure_efd", schema="efd_lsstcomcam")
    # ### end Alembic commands ###
