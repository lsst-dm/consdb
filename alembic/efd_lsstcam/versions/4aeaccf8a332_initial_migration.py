...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("visit1_efd_unpivoted", schema="efd2_lsstcam")
    op.drop_table("visit1_efd", schema="efd2_lsstcam")
    op.drop_table("exposure_efd_unpivoted", schema="efd2_lsstcam")
    op.drop_table("exposure_efd", schema="efd2_lsstcam")
    # ### end Alembic commands ###
