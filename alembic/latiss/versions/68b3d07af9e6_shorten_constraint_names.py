...
Revision ID: 68b3d07af9e6
Revises: 970dc2b4e727
Create Date: 2026-05-14 23:22:28.696408+00:00
...
def upgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE cdb_latiss.exposure_flexdata"
    ...
    op.execute(
        "ALTER TABLE cdb_latiss.ccdexposure_camera"
    ...
    op.execute(
        "ALTER TABLE cdb_latiss.ccdexposure_flexdata"
    ...
    op.execute(
        "ALTER TABLE cdb_latiss.exposure_quicklook"
    ...
    op.execute(
        "ALTER TABLE cdb_latiss.visit1_quicklook"
    ...
    op.execute("GRANT SELECT ON cdb_latiss.ccdexposure_quicklook TO usdf;")
    op.execute("GRANT SELECT ON cdb_latiss.ccdexposure_quicklook TO oods;")


def downgrade() -> None:
    op.execute("REVOKE SELECT ON cdb_latiss.ccdexposure_quicklook FROM oods;")
    op.execute("REVOKE SELECT ON cdb_latiss.ccdexposure_quicklook FROM usdf;")
    op.alter_column(
        "exposure",
        "dimm_seeing",
        existing_type=sa.DOUBLE_PRECISION(precision=53),
