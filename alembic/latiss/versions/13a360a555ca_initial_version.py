...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["exposure_id"], ["cdb_latiss.exposure.exposure_id"], name="fk_exposure_id"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["key"], ["cdb_latiss.exposure_flexdata_schema.key"], name="fk_key"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["key"], ["cdb_latiss.ccdexposure_flexdata_schema.key"], name="fk_key"
        ),
        sa.ForeignKeyConstraint(
            ["obs_id"], ["cdb_latiss.ccdexposure.ccdexposure_id"], name="fk_obs_id"
        ),
        sa.PrimaryKeyConstraint("obs_id", "key"),
        schema="cdb_latiss",
    )
