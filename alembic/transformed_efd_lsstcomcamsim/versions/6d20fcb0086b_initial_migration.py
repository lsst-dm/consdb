...
Revision ID: 6d20fcb0086b
Revises:
Create Date: 2025-04-02 20:59:57.995942+00:00
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("visit1_efd_unpivoted", schema="efd_lsstcomcamsim")
    op.drop_table("visit1_efd", schema="efd_lsstcomcamsim")
    op.drop_table("transformed_efd_scheduler", schema="efd_lsstcomcamsim")
    op.drop_table("exposure_efd_unpivoted", schema="efd_lsstcomcamsim")
    op.drop_table("exposure_efd", schema="efd_lsstcomcamsim")
    # ### end Alembic commands ###
