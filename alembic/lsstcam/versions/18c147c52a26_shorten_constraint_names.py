...
down_revision: str | None = "08383dba5e85"
...
def upgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE cdb_lsstcam.exposure RENAME CONSTRAINT un_exposure_day_obs_seq_num TO un_exposure_ds"
    )
    op.execute(
...
def downgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE cdb_lsstcam.exposure RENAME CONSTRAINT un_exposure_ds TO un_exposure_day_obs_seq_num"
    )
    op.execute(
        "ALTER TABLE cdb_lsstcam.ccdexposure"
