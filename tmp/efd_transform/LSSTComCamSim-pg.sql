...
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex110_sonic_temperature_stddev_mean IS 'Standard devation of sonic temperature (air temperature measured sonically) estimated from quartiles.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex110_sonic_temperature_stddev_stddev IS 'Standard devation of sonic temperature (air temperature measured sonically) estimated from quartiles.';
...
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_acceleration_z_max IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd.mt_salindex104_accelerationpsd_z_max IS 'Acceleration in z direction.';
...
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd_unpivoted.property IS 'Property name for the unpivoted data';
COMMENT ON COLUMN cdb_lsstcomcamsim.exposure_efd_unpivoted.field IS 'Field name for the unpivoted data';
...
COMMENT ON CONSTRAINT un_exposure_property_field ON cdb_lsstcomcamsim.exposure_efd_unpivoted IS 'Ensure the combination of exposure_id, property, and field is unique.';
...
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex110_sonic_temperature_stddev_mean IS 'Standard devation of sonic temperature (air temperature measured sonically) estimated from quartiles.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex110_sonic_temperature_stddev_stddev IS 'Standard devation of sonic temperature (air temperature measured sonically) estimated from quartiles.';
...
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_acceleration_z_max IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd.mt_salindex104_accelerationpsd_z_max IS 'Acceleration in z direction.';
...
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd_unpivoted.property IS 'Property name for the unpivoted data';
COMMENT ON COLUMN cdb_lsstcomcamsim.visit1_efd_unpivoted.field IS 'Field name for the unpivoted data';
...
COMMENT ON CONSTRAINT un_visit_property_field ON cdb_lsstcomcamsim.visit1_efd_unpivoted IS 'Ensure the combination of visit_id, property, and field is unique.';
