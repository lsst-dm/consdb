...
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_wind_speed_0_mean IS 'Median wind speed (x, y, z) in AuxTel-ESS04 along axis 0 (salIndex 201)';
...
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speed_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speed_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speed_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speed_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speedstddev_mean IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speedstddev_stddev IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speedstddev_min IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_speedstddev_max IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_direction_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_direction_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_direction_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_airflow_direction_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
...
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speed_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speed_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speed_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speed_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speedstddev_mean IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speedstddev_stddev IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speedstddev_min IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_speedstddev_max IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_direction_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_direction_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_direction_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex205_airflow_direction_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_0_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_0_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_0_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_0_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_1_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_1_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_1_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_1_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_2_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_2_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_2_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_2_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_3_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_3_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_3_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_3_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_4_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_4_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_4_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_4_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_5_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_5_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_5_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_5_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_6_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_6_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_6_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_6_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_7_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_7_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_7_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_temperature_7_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_0_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_0_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_0_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_0_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_1_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_1_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_1_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_1_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_2_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_2_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_2_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_2_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_3_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_3_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_3_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_3_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_4_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_4_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_4_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_4_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_5_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_5_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_5_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_5_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_6_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_6_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_6_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_6_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_7_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_7_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_7_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_temperature_7_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
...
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_acceleration_z_max IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex202_accelerationpsd_z_max IS 'Acceleration in z direction.';
...
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_pressure_0_mean IS 'Atmosferic pressure item 0 in AuxTel-ESS02';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex201_pressure_1_mean IS 'Atmosferic pressure item 1 in AuxTel-ESS02';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_pressure_0_mean IS 'Atmosferic pressure item 0 in weather tower atmospheric pressure';
COMMENT ON COLUMN cdb_latiss.exposure_efd.at_salindex301_pressure_1_mean IS 'Atmosferic pressure item 1 in weather tower atmospheric pressure';
...
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_wind_speed_0_mean IS 'Median wind speed (x, y, z) in AuxTel-ESS04 along axis 0 (salIndex 201)';
...
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speed_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speed_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speed_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speed_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speedstddev_mean IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speedstddev_stddev IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speedstddev_min IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_speedstddev_max IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 201). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_direction_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_direction_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_direction_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_airflow_direction_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 201)';
...
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speed_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speed_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speed_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speed_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speedstddev_mean IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speedstddev_stddev IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speedstddev_min IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_speedstddev_max IS 'Standard deviation of wind speed estimated from quartiles in XX (salIndex 205). Not available for all sensor types.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_direction_mean IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_direction_stddev IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_direction_min IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex205_airflow_direction_max IS 'Median (mean for some sensors) wind speed in XX (salIndex 205)';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_0_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_0_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_0_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_0_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_1_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_1_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_1_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_1_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_2_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_2_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_2_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_2_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_3_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_3_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_3_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_3_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_4_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_4_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_4_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_4_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_5_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_5_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_5_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_5_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_6_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_6_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_6_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_6_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_7_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_7_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_7_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_temperature_7_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_0_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_0_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_0_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_0_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 0';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_1_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_1_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_1_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_1_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 1';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_2_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_2_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_2_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_2_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 2';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_3_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_3_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_3_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_3_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 3';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_4_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_4_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_4_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_4_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 4';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_5_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_5_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_5_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_5_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 5';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_6_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_6_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_6_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_6_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 6';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_7_mean IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_7_stddev IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_7_min IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_temperature_7_max IS 'AuxTel-ESS01, AuxTel-ESS02, AuxTel-ESS03 temperature item 7';
...
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_acceleration_z_max IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_x_mean IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_x_stddev IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_x_min IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_x_max IS 'Acceleration in x direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_y_mean IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_y_stddev IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_y_min IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_y_max IS 'Acceleration in y direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_z_mean IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_z_stddev IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_z_min IS 'Acceleration in z direction.';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex202_accelerationpsd_z_max IS 'Acceleration in z direction.';
...
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_pressure_0_mean IS 'Atmosferic pressure item 0 in AuxTel-ESS02';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex201_pressure_1_mean IS 'Atmosferic pressure item 1 in AuxTel-ESS02';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_pressure_0_mean IS 'Atmosferic pressure item 0 in weather tower atmospheric pressure';
COMMENT ON COLUMN cdb_latiss.visit1_efd.at_salindex301_pressure_1_mean IS 'Atmosferic pressure item 1 in weather tower atmospheric pressure';
